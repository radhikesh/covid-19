...
MAINTAINER Radhikesh Ranadive "rradhikesh@gmail.com"
...
CMD ["R", "-e", "rmarkdown::run('/bin/index.Rmd', shiny_args = list(port = 3838, host = '34.70.155.183'))"]
